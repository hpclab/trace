...
public class HotspotProbabilityObjectPlacement extends AStaticPlacement
{

	private final int objectNumber;

	public HotspotProbabilityObjectPlacement(final PropertiesPersonalized conf, final IdProvider idProvider)
	{
	...
	public Entity[] place(final MapVirtualEnvironment map)
	{
		...
		for (int i=0; i<objectNumber; i++)
		{
			objects[i] = new PassiveObject(idProvider.addOne(),
					PlacementUtils.pointInHotspotProbability(map, 0.8));
		}
